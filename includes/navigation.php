                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-2 w-56 rounded-md shadow-lg bg-gray-900 ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                            <div class="py-1" role="menu" aria-orientation="vertical">
                                ...
                                <a href="<?php echo Config::url('web-dev'); ?>" class="block px-4 py-2 text-sm text-white hover:bg-gray-800" role="menuitem">Web Development</a>
                                <a href="<?php echo Config::url('cloud'); ?>" class="block px-4 py-2 text-sm text-white hover:bg-gray-800" role="menuitem">Cloud Solutions</a>
                                <a href="<?php echo Config::url('ai-ml'); ?>" class="block px-4 py-2 text-sm text-white hover:bg-gray-800" role="menuitem">AI & Machine Learning</a>
                                <a href="<?php echo Config::url('digital-transformation'); ?>" class="block px-4 py-2 text-sm text-white hover:bg-gray-800" role="menuitem">Digital Transformation</a>
                            </div>
                        </div>
                    </div>
